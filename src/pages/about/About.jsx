...
const achievements = [
  { number: "13+", label: "Years of Design Expertise" },
  { number: "26K+", label: "UIBundle.com Designers & Developers" },
  { number: "$51M+", label: "In Funding Including Silicon Valley" },
  { number: "97M+", label: "Web3 Growth & Adoption Impact" },
];
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3 mb-8">
                      {[
                        ...
                        <span key={tag.label} className="bg-[#343434] text-white text-sm px-4 py-2 rounded-xl font-medium flex items-center gap-2">
                    ...
                    <div className="flex flex-col gap-0">
                      {[
                        ...
                        <div key={idx} className="flex items-start justify-between bg-transparent rounded-2xl px-4 py-4 md:px-6 md:py-5">
                          <div className="flex items-center gap-4 md:gap-6 w-full">
                            ...
                            <div className="flex-1">
                              <div className="text-white font-semibold text-base md:text-lg leading-tight">{job.title}</div>
                              <div className="text-gray-300 text-sm md:text-sm font-medium">{job.company}</div>
                              <div className="text-gray-500 text-xs md:text-xs">{job.location}</div>
                            </div>
                          </div>
                          <div className="flex flex-col items-end min-w-[150px] ml-2 md:ml-0">
                            <div className="text-white text-xs md:text-sm font-medium">{job.date}</div>
                            <div className="text-gray-400 text-xs">({job.duration})</div>
                          </div>
                        </div>
                      ))}
                    </div>
                  ...
                  <p className="text-gray-300 text-base md:text-lg leading-relaxed">
                    {
                      sec.id === 'tools' ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                          {[
                            { name: 'Figma', subtitle: 'Interface Design Tool', logo: '/skills/figma.png' },
                            ...
                            { name: 'Lovable', subtitle: 'AI Code Completion', logo: '/skills/lovable.png', },
                            { name: 'Cursor', subtitle: 'AI-Powered Code Editor', logo: '/skills/cursor.png' },
                          ].map((tool, idx) => (
                            <div
                              key={tool.name}
                            ...
                            >
                              <div className="flex items-center gap-4 w-full">
                                <img src={tool.logo} alt={tool.name} className="w-12 h-12 object-contain rounded-lg" />
                                <div>
                                  <div className="text-white font-semibold text-base md:text-lg leading-tight">{tool.name}
                                    {tool.external && (
                                      <span className="ml-1 align-middle text-xs">↗</span>
                                    )}
                                  </div>
                                  <div className="text-gray-400 text-xs md:text-sm font-normal">{tool.subtitle}</div>
                                </div>
                              </div>
                              <div className="flex-shrink-0 ml-4">
                                <svg width="22" height="22" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-400 group-hover:text-white transition" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                              </div>
                            </div>
                          ))}
                        </div>
                          ...
                          (
                            <div className="w-full relative overflow-hidden py-2">
                              ...
                              <div
                                ...
                                style={{
                                  background: "linear-gradient(90deg, #101010 60%, rgba(16,16,16,0.7) 80%, transparent 100%)",
                                }}
                              ></div>
                              ...
                              <div
                                ...
                                style={{
                                  background: "linear-gradient(270deg, #101010 60%, rgba(16,16,16,0.7) 80%, transparent 100%)",
                                }}
                              ></div>
